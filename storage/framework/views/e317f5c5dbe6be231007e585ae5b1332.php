...
<?php $__env->startSection('page-title', 'Create Receivables'); ?>
...
<form action="<?php echo e(route('receivables.store')); ?>" method="POST">
  <?php echo csrf_field(); ?>
  <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\accounting-management\resources\views/receivables/create.blade.php ENDPATH**/ ?>