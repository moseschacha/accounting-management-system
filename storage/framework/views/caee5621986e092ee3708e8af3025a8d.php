...
<script src="path/to/bootstrap.min.js"></script>
    ...
    <title><?php echo $__env->yieldContent('title', 'Accounting Management | Inc'); ?></title>
            ...
            <nav id="sidebarMenu " class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('receivables.index')); ?>">
                                <span data-feather="briefcase"></span>
                                receivables
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('payables.index')); ?>">
...
<?php /**PATH C:\xampp\htdocs\accounting-management\resources\views/layouts/app.blade.php ENDPATH**/ ?>